...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://wpadmin:123456@localhost/wordpress_db?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'http://localhost/';
$civicrm_paths['wp.backend.base']['url'] = 'http://localhost/wp-admin/';
$civicrm_setting['URL Preferences']['userFrameworkResourceURL'] = 'http://localhost/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://wpadmin:123456@localhost:3306/wordpress_db?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/wordpress/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/wordpress/wp-content/uploads/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '9d33dfa0a5725e380481200538462bb1');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/wordpress/wp-content/uploads/civicrm/templates_c//mail.log');
// }
